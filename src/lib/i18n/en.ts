export const en = {
  ...
  'vendor.apply.locationTypeLabel': 'Location',
  'vendor.apply.onCampusOption': 'On-campus (KMUTT)',
  'vendor.apply.offCampusOption': 'Off-campus',
  'vendor.apply.stallNumberLabel': 'Stall Number (optional)',
  'vendor.apply.addressLabel': 'Address (optional)',
