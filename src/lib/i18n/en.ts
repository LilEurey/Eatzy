export const en = {
  ...
  'home.trendingToday': 'Trending Meals Today',
  ...
  'wallet.topUp': 'Top Up',
  'wallet.escrow': 'Held · ฿{amount}',
  'wallet.escrowTitle': 'Held in escrow',
  'wallet.escrowEmpty': 'No active orders — nothing is held.',
  'wallet.escrowQueue': 'Queue #{n}',
  'wallet.statement': 'Statement',
  'wallet.statementIn': 'Money in',
  'wallet.statementOut': 'Money out',
  'wallet.statementNet': 'Net change',
  'wallet.statementEmpty': 'No transactions this month',
  'wallet.statementShare': 'Share',
  ...
  'wallet.topUpAmountTitle': 'Top Up',
  'wallet.topUpCustomLabel': 'Or enter a custom amount',
  'wallet.topUpMinMaxHint': 'Min ฿20 · Max ฿10,000',
  'wallet.topUpInvalidAmount': 'Enter an amount between ฿20 and ฿10,000',
  'wallet.topUpCta': 'Top Up · ฿{amount}',
  'wallet.topUpSuccess': 'Topped up ฿{amount}',
  ...
  'help.faqHeader': 'FREQUENTLY ASKED',
  'help.q.preorder': 'How does pre-ordering work?',
  'help.a.preorder': 'Pick a pickup time slot at checkout. The stall gets your order right away and has it ready for your slot. Show your queue number at the counter.',
  'help.q.wallet': 'Where does my money go when I pay?',
  'help.a.wallet': 'Campus Wallet holds your payment. The vendor is paid only after you pick up and the order is completed. If the order is rejected or cancelled, the money returns to your wallet.',
  'help.q.cancel': 'Can I cancel an order?',
  'help.a.cancel': 'Yes, while it is still pending. Once the vendor accepts, only the vendor can cancel it — you are refunded automatically.',
  'help.q.topup': 'How do I top up my wallet?',
  'help.a.topup': 'Wallet > Top up, pay with PromptPay. Top-ups are ฿20 to ฿10,000 and credit once payment is confirmed.',
  'help.q.dietary': 'How do dietary filters and allergies work?',
  'help.a.dietary': 'Halal, Vegetarian and Jay hide dishes you cannot eat everywhere in the app. Allergies never hide dishes — you get a warning before adding a dish that contains them.',
  'help.q.queue': 'What is my queue number?',
  'help.a.queue': 'Each stall numbers its orders per day. Track it on the order screen and give it at the counter when picking up.',
  'help.q.problem': 'Something is wrong with my order',
  'help.a.problem': 'Email us below with your queue number and stall name, and we will sort it out.',
  'help.contactHeader': 'STILL NEED HELP?',
  'help.contact': 'Email support',
  ...
  'track.rejectedMsg': '{vendor} couldn’t accept this order.',
  'track.cancelledMsg': 'This order was cancelled.',
  'track.terminalNoCharge': 'Nothing was charged to your wallet.',
  'track.terminalRefund': 'Your payment is being returned to your wallet.',
  'notif.orderRejected.title': 'Order rejected',
  'notif.orderRejected.body': "{vendor} couldn't accept your order.",
  'notif.orderRefunded.title': 'Order cancelled',
  'notif.orderRefunded.body': "{vendor} cancelled your order — you've been refunded.",
  ...
  'vendor.orders.cancelRefund': 'Cancel & refund',
  'vendor.orders.cancelTitle': 'Cancel this order?',
  'vendor.orders.cancelMsg': 'The customer will be refunded in full and notified. This can’t be undone.',
  'vendor.orders.cancelConfirm': 'Cancel order',
  'vendor.err.loadStore': "Could not load your store",
  'vendor.err.acceptOrder': "Could not accept order",
  'vendor.err.autoRejectedTitle': "Order auto-rejected",
  'vendor.err.autoRejectedMsg': "Customer's balance changed and is no longer enough to cover this order.",
  'vendor.err.rejectOrder': "Could not reject order",
  'vendor.err.notPending': "This order is no longer pending.",
  'vendor.err.updateOrder': "Could not update order",
  'vendor.err.notAccepted': "This order is no longer accepted.",
  'vendor.err.cancelOrder': "Could not cancel order",
  'vendor.err.handoff': "Could not confirm hand-off",
  'vendor.err.availability': "Could not update availability",
  'vendor.err.saveItem': "Could not save item",
  'vendor.err.storeStatus': "Could not update store status",
  'vendor.err.saveProfile': "Could not save profile",
  'vendor.err.payoutSetup': "Could not start payout setup",
  'vendor.err.tryAgain': "Please try again.",
  ...
  'vendor.menu.deleteConfirmMsg': 'Remove "{name}" from your menu? This cannot be undone.',
  'vendor.menu.deleteBlockedTitle': "Can't delete this item",
  'vendor.menu.deleteBlockedMsg': 'This item has past orders, so it can\'t be removed. Turn off Availability instead to hide it from the menu.',
  'vendor.menu.deleteErrorTitle': 'Could not delete item',
  ...
  'vendor.menuNew.ingredientsLabel': 'Ingredients',
  'vendor.menuNew.ingredientsPlaceholder': 'e.g. rice, chicken, basil, egg (comma separated)',
  'vendor.menuNew.tagsLabel': 'Tags',
  'vendor.menuNew.tagsPlaceholder': 'e.g. spicy, stir-fried, thai (comma separated)',
