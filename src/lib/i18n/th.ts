...
export const th: Record<TranslationKey, string> = {
  ...
  'vendor.apply.locationTypeLabel': 'ที่ตั้ง',
  'vendor.apply.onCampusOption': 'ในมหาวิทยาลัย (KMUTT)',
  'vendor.apply.offCampusOption': 'นอกมหาวิทยาลัย',
  'vendor.apply.stallNumberLabel': 'หมายเลขแผง (ไม่บังคับ)',
  'vendor.apply.addressLabel': 'ที่อยู่ (ไม่บังคับ)',
