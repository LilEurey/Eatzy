...
export const th: Record<TranslationKey, string> = {
  ...
  'home.trendingToday': 'เมนูกำลังฮิตวันนี้',
  ...
  'wallet.escrow': 'พักไว้ · ฿{amount}',
  'wallet.escrowTitle': 'เงินที่พักไว้ (Escrow)',
  'wallet.escrowEmpty': 'ไม่มีออเดอร์ที่กำลังดำเนินการ ไม่มีเงินพักไว้',
  'wallet.escrowQueue': 'คิว #{n}',
  'wallet.statement': 'รายการเดินบัญชี',
  'wallet.statementIn': 'เงินเข้า',
  'wallet.statementOut': 'เงินออก',
  'wallet.statementNet': 'เปลี่ยนแปลงสุทธิ',
  'wallet.statementEmpty': 'ไม่มีรายการในเดือนนี้',
  'wallet.statementShare': 'แชร์',
  ...
  'wallet.topUpAmountTitle': 'เติมเงิน',
  'wallet.topUpCustomLabel': 'หรือระบุจำนวนเงินเอง',
  'wallet.topUpMinMaxHint': 'ขั้นต่ำ ฿20 · สูงสุด ฿10,000',
  'wallet.topUpInvalidAmount': 'กรุณาระบุจำนวนเงินระหว่าง ฿20 ถึง ฿10,000',
  'wallet.topUpCta': 'เติมเงิน · ฿{amount}',
  'wallet.topUpSuccess': 'เติมเงินสำเร็จ ฿{amount}',
  ...
  'help.faqHeader': 'คำถามที่พบบ่อย',
  'help.q.preorder': 'สั่งล่วงหน้าทำงานอย่างไร?',
  'help.a.preorder': 'เลือกช่วงเวลารับอาหารตอนชำระเงิน ร้านจะได้รับออร์เดอร์ทันทีและเตรียมให้พร้อมตามเวลา แสดงหมายเลขคิวที่เคาน์เตอร์',
  'help.q.wallet': 'เงินที่จ่ายไปอยู่ที่ไหน?',
  'help.a.wallet': 'Campus Wallet จะพักเงินไว้ ร้านจะได้รับเงินหลังคุณรับอาหารและออร์เดอร์เสร็จสิ้น หากออร์เดอร์ถูกปฏิเสธหรือยกเลิก เงินจะคืนเข้ากระเป๋าของคุณ',
  'help.q.cancel': 'ยกเลิกออร์เดอร์ได้ไหม?',
  'help.a.cancel': 'ได้ ขณะที่ออร์เดอร์ยังรอดำเนินการ เมื่อร้านรับออร์เดอร์แล้ว มีเพียงร้านที่ยกเลิกได้ และคุณจะได้รับเงินคืนอัตโนมัติ',
  'help.q.topup': 'เติมเงินเข้ากระเป๋าอย่างไร?',
  'help.a.topup': 'ไปที่ Wallet > เติมเงิน ชำระด้วยพร้อมเพย์ เติมได้ ฿20 ถึง ฿10,000 และเงินจะเข้าเมื่อยืนยันการชำระแล้ว',
  'help.q.dietary': 'ตัวกรองอาหารและการแพ้อาหารทำงานอย่างไร?',
  'help.a.dietary': 'ฮาลาล มังสวิรัติ และเจ จะซ่อนเมนูที่คุณทานไม่ได้ทั่วทั้งแอป ส่วนการแพ้อาหารจะไม่ซ่อนเมนู แต่จะเตือนก่อนเพิ่มเมนูที่มีสารก่อภูมิแพ้',
  'help.q.queue': 'หมายเลขคิวคืออะไร?',
  'help.a.queue': 'แต่ละร้านนับคิวใหม่ทุกวัน ติดตามได้ที่หน้าออร์เดอร์ และแจ้งหมายเลขที่เคาน์เตอร์ตอนรับอาหาร',
  'help.q.problem': 'ออร์เดอร์ของฉันมีปัญหา',
  'help.a.problem': 'ส่งอีเมลถึงเราด้านล่าง พร้อมหมายเลขคิวและชื่อร้าน แล้วเราจะช่วยแก้ไขให้',
  'help.contactHeader': 'ยังต้องการความช่วยเหลือ?',
  'help.contact': 'ส่งอีเมลถึงฝ่ายช่วยเหลือ',
  ...
  'track.rejectedMsg': '{vendor} ไม่สามารถรับออเดอร์นี้ได้',
  'track.cancelledMsg': 'ออเดอร์นี้ถูกยกเลิกแล้ว',
  'track.terminalNoCharge': 'ไม่มีการหักเงินจากกระเป๋าเงินของคุณ',
  'track.terminalRefund': 'กำลังคืนเงินเข้ากระเป๋าเงินของคุณ',
  'notif.orderRejected.title': 'ออเดอร์ถูกปฏิเสธ',
  'notif.orderRejected.body': '{vendor} ไม่สามารถรับออเดอร์ได้',
  'notif.orderRefunded.title': 'ออเดอร์ถูกยกเลิก',
  'notif.orderRefunded.body': '{vendor} ยกเลิกออเดอร์ของคุณ และคืนเงินให้แล้ว',
  ...
  'vendor.overview.avgFulfilment': 'เวลาส่งมอบเฉลี่ย',
  'vendor.overview.vsPrevPeriod': 'เทียบช่วงก่อนหน้า',
  'vendor.overview.topSellers': 'เมนูขายดี',
  'vendor.overview.topSellersCaption': 'ตามจำนวนที่ขายได้',
  'vendor.overview.unitsSold': 'ขายได้ {n}',
  'vendor.overview.slowMovers': 'เมนูขายช้า',
  'vendor.overview.slowMoverHint': 'ไม่มียอดขายในช่วงนี้ — ลองจัดโปรโมชัน',
  'vendor.overview.salesVelocity': 'ยอดขาย',
  'vendor.overview.salesPerHour': '฿ / ชม.',
  'vendor.overview.salesPerDay': '฿ / วัน',
  'vendor.overview.noSalesRange': 'ไม่มียอดขายในช่วงนี้',
  'vendor.overview.trafficHeatmap': 'ช่วงเวลาที่คนเยอะ',
  'vendor.overview.busyTimesCaption': '4 สัปดาห์ล่าสุด',
  'vendor.overview.morning': 'เช้า',
  'vendor.overview.lunch': 'เที่ยง',
  'vendor.overview.evening': 'เย็น',
  'vendor.overview.dow.mon': 'จ.',
  'vendor.overview.dow.tue': 'อ.',
  'vendor.overview.dow.wed': 'พ.',
  'vendor.overview.dow.thu': 'พฤ.',
  'vendor.overview.dow.fri': 'ศ.',
  'vendor.overview.dow.sat': 'ส.',
  'vendor.overview.dow.sun': 'อา.',
  ...
  'vendor.orders.cancelRefund': 'ยกเลิกและคืนเงิน',
  'vendor.orders.cancelTitle': 'ยกเลิกออเดอร์นี้?',
  'vendor.orders.cancelMsg': 'ลูกค้าจะได้รับเงินคืนเต็มจำนวนและได้รับแจ้งเตือน การดำเนินการนี้ย้อนกลับไม่ได้',
  'vendor.orders.cancelConfirm': 'ยกเลิกออเดอร์',
  'vendor.err.loadStore': "โหลดข้อมูลร้านไม่สำเร็จ",
  'vendor.err.acceptOrder': "รับออเดอร์ไม่สำเร็จ",
  'vendor.err.autoRejectedTitle': "ออเดอร์ถูกปฏิเสธอัตโนมัติ",
  'vendor.err.autoRejectedMsg': "ยอดเงินของลูกค้าเปลี่ยนไปและไม่พอสำหรับออเดอร์นี้แล้ว",
  'vendor.err.rejectOrder': "ปฏิเสธออเดอร์ไม่สำเร็จ",
  'vendor.err.notPending': "ออเดอร์นี้ไม่อยู่ในสถานะรอรับแล้ว",
  'vendor.err.updateOrder': "อัปเดตออเดอร์ไม่สำเร็จ",
  'vendor.err.notAccepted': "ออเดอร์นี้ไม่อยู่ในสถานะรับแล้ว",
  'vendor.err.cancelOrder': "ยกเลิกออเดอร์ไม่สำเร็จ",
  'vendor.err.handoff': "ยืนยันการส่งมอบไม่สำเร็จ",
  'vendor.err.availability': "อัปเดตสถานะเมนูไม่สำเร็จ",
  'vendor.err.saveItem': "บันทึกเมนูไม่สำเร็จ",
  'vendor.err.storeStatus': "อัปเดตสถานะร้านไม่สำเร็จ",
  'vendor.err.saveProfile': "บันทึกโปรไฟล์ไม่สำเร็จ",
  'vendor.err.payoutSetup': "เริ่มตั้งค่าการรับเงินไม่สำเร็จ",
  'vendor.err.tryAgain': "กรุณาลองอีกครั้ง",
  ...
  'vendor.menu.deleteConfirmMsg': 'ลบ "{name}" ออกจากเมนูใช่ไหม? ไม่สามารถย้อนกลับได้',
  'vendor.menu.deleteBlockedTitle': 'ลบเมนูนี้ไม่ได้',
  'vendor.menu.deleteBlockedMsg': 'เมนูนี้มีประวัติการสั่งซื้อแล้ว จึงลบไม่ได้ ปิดสถานะ "พร้อมขาย" แทนเพื่อซ่อนจากเมนู',
  'vendor.menu.deleteErrorTitle': 'ลบเมนูไม่สำเร็จ',
  'vendor.menu.manageAddons': 'ท็อปปิ้ง',
  'vendor.menu.bestSeller': 'ขายดีที่สุด',
  'vendor.menu.topSellerRank': 'อันดับ {n} ขายดี',
  'vendor.menu.soldCount': 'ขายได้ {n} · 30 วัน',
  'vendor.menu.noSalesYet': 'ยังไม่มียอดขาย',

  // Vendor — reviews
  'vendor.reviews.title': 'รีวิว',
  'vendor.reviews.subtitle': 'เสียงจากลูกค้าเกี่ยวกับเมนูของคุณ',
  'vendor.reviews.overallRating': 'คะแนนรวม',
  'vendor.reviews.reviewCount': '{n} รีวิว',
  'vendor.reviews.reviewCountOne': '1 รีวิว',
  'vendor.reviews.perItem': 'ตามเมนู',
  'vendor.reviews.sortWorst': 'คะแนนต่ำสุดก่อน',
  'vendor.reviews.sortBest': 'คะแนนสูงสุดก่อน',
  'vendor.reviews.feed': 'รีวิวทั้งหมด',
  'vendor.reviews.empty': 'ยังไม่มีรีวิว',
  'vendor.reviews.emptyHint': 'คะแนนจากออเดอร์ที่เสร็จสิ้นจะแสดงที่นี่',
  'vendor.reviews.anonymous': 'นักศึกษา',
  'vendor.reviews.noComment': 'ไม่มีความคิดเห็น',
  'vendor.reviews.ratingsCount': '{n} คะแนน',
  'vendor.reviews.ratingsCountOne': '1 คะแนน',
  ...
  'vendor.menuNew.halalLabel': 'ฮาลาล',
  'vendor.menuNew.vegetarianLabel': 'มังสวิรัติ',
  'vendor.menuNew.jayLabel': 'เจ',
  ...
  'vendor.menuNew.ingredientsLabel': 'ส่วนผสม',
  'vendor.menuNew.ingredientsPlaceholder': 'เช่น ข้าว, ไก่, โหระพา, ไข่ (คั่นด้วยจุลภาค)',
  'vendor.menuNew.tagsLabel': 'แท็ก',
  'vendor.menuNew.tagsPlaceholder': 'เช่น เผ็ด, ผัด, ไทย (คั่นด้วยจุลภาค)',
