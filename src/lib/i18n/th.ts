...
export const th: Record<TranslationKey, string> = {
  ...
  'vendor.apply.subtitle': 'บอกเราเกี่ยวกับร้านของคุณ แล้วแอดมินจะตรวจสอบใบสมัคร',
  'vendor.apply.businessNameLabel': 'ชื่อร้าน',
  'vendor.apply.cuisineTagsLabel': 'ร้านคุณขายอะไร?',
  'vendor.apply.cuisineTagsPlaceholder': 'เช่น ไทย, ข้าวราดแกง, แกง',
  'vendor.apply.cuisineTagsHint': 'คั่นแต่ละแท็กด้วยจุลภาค',
  ...
  'admin.applications.subtitle': 'ตรวจสอบและอนุมัติใบสมัครผู้ขาย',
  'admin.applications.empty': 'ไม่มีใบสมัครที่รอตรวจสอบ',
  'admin.applications.colApplicant': 'ผู้สมัคร',
  'admin.applications.colBusiness': 'ร้านค้า',
  ...
  'admin.applications.businessLabel': 'ร้านค้า',
  'admin.applications.cuisineTagsLabel': 'ขายอะไร',
